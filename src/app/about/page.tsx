...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "navinder.tech@gmail.com",
    href: "mailto:navinder.tech@gmail.com",
  ...
  {
    name: "LinkedIn",
    href: "https://my.linkedin.com/in/navinder-tech-b2600538a",
    content: "/Navinder-Dinesh-Ram",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/NeoV55",
    content: "/Navinder-Dinesh-Ram",
...
const CERTIFICATIONS = [
  { name: "CPTE", icon: "/assets/badges/all_badges.png" },
  { name: "CISE", icon: "/assets/badges/all_badges.png" },
  { name: "Microsoft Professional", icon: "/assets/badges/all_badges.png" },
  { name: "CCNA Security", icon: "/assets/badges/all_badges.png" },
  { name: "Microsoft Associate", icon: "/assets/badges/all_badges.png" },
  { name: "MCSA 2012", icon: "/assets/badges/all_badges.png" },
  { name: "CCNA", icon: "/assets/badges/all_badges.png" },
];
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Navinder Dinesh Ram</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Navinder, a Fullstack developer passionate about
            ...
            <h1 className="text-3xl mb-10 lg:md-20">Certifications</h1>
            <div className="mb-5">
              {!toolsLoaded ? (
                <p className="h-[100px]"></p>
              ) : (
                ...
                >
                  {CERTIFICATIONS.map((cert, index) => (
                    <SplideSlide key={`${cert.name}_${index}`}>
                      <div className="w-fit p-4 border-[.5px] border-zinc-600 rounded-md bg-zinc-800/50">
                        <img
                          src={cert.icon}
                          alt={cert.name}
