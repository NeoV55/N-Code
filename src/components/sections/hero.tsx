            ...
            <>
              <div>
                ...
                <BlurIn delay={1.2}>
                  <p
                    className={cn(
                      "md:self-start md:mt-4 font-thin text-md text-slate-600 dark:text-zinc-400 ml-3",
                      "cursor-default font-display sm:text-xl md:text-xl bg-clip-text "
                    )}
                  >
              ...
              <div className="mt-8 md:ml-2 flex flex-col gap-3">
                ...
                <div className="md:self-start flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
                  <Tooltip delayDuration={300}>
                    <TooltipTrigger asChild>
